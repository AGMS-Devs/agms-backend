...
using UserForLoginDto = NArchitecture.Core.Application.Dtos.UserForLoginDto;
using UserForRegisterDto = Application.Features.Auth.Commands.Register.UserForRegisterDto;
